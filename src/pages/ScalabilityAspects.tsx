...
const ScalabilityAspects = () => {
  ...
  const { aspects, handleAspectClick, handleFindingsChange, handleOwnersChange } = useScalabilityAspects(projectName, assessmentDate);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.log('Successfully saved scalability rating:', overallRating);
